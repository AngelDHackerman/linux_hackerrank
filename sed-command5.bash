...
# each of this: `([0-9]{4}) ` represent a group and a empty space 
# we have 4 groups of 4 digits between 0 and 9
# then we change the order of the grups by using the \4 \3 \2 \1 expression. 

sed -r 's/([0-9]{4}) ([0-9]{4}) ([0-9]{4}) ([0-9]{4})/\4 \3 \2 \1/g'
